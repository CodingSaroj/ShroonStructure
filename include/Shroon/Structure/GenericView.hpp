...
namespace Shroon
{
    ...
    namespace Structure
    {
        ...
        public:
            ...
            /**
             * @brief Returns a <t>UnitType &</t> at index \p index inside the memory block.
             *
             * @param index The index inside the memory block from which data needs to be fetched.
             *
             * @return A <t>UnitType &</t> at \p index inside the memory block.
             */
            ...
            /**
             * @brief Returns a <t>const UnitType &</t> at index \p index inside the memory block.
             *
             * @param index The index inside the memory block from which data needs to be fetched.
             *
             * @return A <t>const UnitType &</t> at \p index inside the memory block.
             */
             ...
             * Defaults to \p SIZE_MAX.
             *
             * @return A <t>const GenericView</t> viewing memory \p begin bytes after start of this
 ...
 *
 * @param out The <t>std::ostream &</t> to output the content of \p view to.
 * @param view The <t>GenericView<UnitType></t> whose content needs to be written to \p out.
 *
 ...
 * </t>
 * 
 * then what <t>std::cout<<view;<\t> will print to \p stdout is this:
 * 
 * <t>
 * 0: a
 * 1: b
 ...
 * </t>
 * 
 * then the output of `std::cout<<memoryView;` will be:
 * 
 * <t>
