...
namespace Shroon
{
    ...
    namespace Structure
    {
        ...
        public:
            /**
             * @brief Constructs a <t>TreeNode<ValueType></t> containing \p value as a child of
             * \p parent.
             *
            ...
            /**
             * @brief Constructs a <t>TreeNode<ValueType></t> containing value which is constructed
             * using \p cargs as a child of \p parent.
             *
            ...
            /**
             * @brief Returns the <t>index</t>th child of this node.
             *
             * @param index Index of the child to return. \p 0 by default.
             *
             * @return An l-value reference to the <t>index</t>th child of this node.
             */
             ...
             * @param index Index of the child to return. \p 0 by default.
             *
             * @return A const l-value reference to the <t>index</t>th child of this node.
             */
        ...
        public:
            /**
             * @brief Constructs a <t>Tree<ValueType><\t> with root node containing \p value.
             *
            ...
            /**
             * @brief Constructs a <t>Tree<ValueType><\t> with root node containing value which is
             ...
             * D  E F  G
             * </t>
             * If we retrieve nodes at height 2 we expect <t>[D, E, F, G]</t> but we get
             * <t>[nullptr, D, E, nullptr, F, G]<\t>. The \p nullptr means the node afterwards are
             ...
             * 
             * In this case:
             * 0: nullptr - Following nodes are children of first parent node (B).
             * 1: D - Child of one node (B).
             * 2: E - Child of one node (B).  
             * 3: nullptr - Following nodes are children of second parent node (C).
             * 4: F - Child of another node (C).
             * 5: G - Child of another node (C).
             */
 ...
 *
 * @param out The <t>std::ostream &</t> to output the content of \p node to.
 * @param view The <t>TreeNode<ValueType></t> whose content needs to be written to \p out.
 *
 ...
 *
 * @param out The <t>std::ostream &</t> to output the content of \p tree to.
 * @param view The <t>Tree<ValueType></t> whose content needs to be written to \p out.
 *
 * @return \p out after outputting content to it.
 *
 ...
 * </t>
 * 
 * Here, nodes inside <t>[]<\t> mean they have the same parent.
 */
template <typename ValueType>
